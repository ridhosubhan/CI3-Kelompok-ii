...
$(function(){ 
		$.ajaxSetup({ type:"POST",    
          url: "<?php  echo base_url('index.php/C02_Password/ambil_data') ?>", cache: false, });
...
<form id="form" method="post" action="Proses_Entrydatapassword_2"> 
<CENTER>
<table width="1027" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <th width="61" scope="col"><span class="style31">FORM-5</span></th>
    <th colspan="2" class="style33" scope="col"><div align="center">PEMBUATAN AKUNTABILITAS DATA PASSWOORD DOSEN PENGAMPU</div></th>
    <th width="74" scope="col"><div align="right"><span class="style31">@NKK_363</span></div></th>
  </tr> 
  
</table>
<table  bgcolor="#87CEEB" width="1028" border="0" cellspacing="1" ; >
  <tr>
  ...
  <tr>
    ...
    <td width="579"><select name="select_fak" class='form-control' id='fakultas'>	  
      ...
      foreach ($data_fakultasx->result_array() as $prov) { echo "<option value='$prov[id_fakultas]'>$prov[id_fakultas] -   $prov[nama_fakultas]</option>"; } ?>
    </select>
  <td colspan="3">  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><form name="form2">
      <select name="menu_password" onChange="#">
	    <option>0. Pilih</option>
        <option>1. Tambah Data</option>
        <option>2. Ralat Data</option>
        <option>3. Hapus Data</option>
        <option>4. Lihat Data</option>
        <option>5. Cari Data</option>
        <option>6. Cetak Data</option>
      </select>
      <label>
