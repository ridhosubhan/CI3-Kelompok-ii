  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b6/index') ?>" class="btn btn-primary float-start">Back</a>
        </div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo site_url('/C03_tb_3b6/add') ?>" method="post" enctype="multipart/form-data" >
                <div class="mb-3 row">
                    <label for="txt_nama_dosen" class="col-sm-2 col-form-label">Nama Dosen<span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_nama_dosen') ? 'is-invalid':'' ?>" type="text" name="txt_nama_dosen" placeholder="Nama Dosen" />
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_nama_produk_jasa') ? 'is-invalid':'' ?>" type="text" name="txt_nama_produk_jasa" placeholder="Nama Produk/Jasa" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_deskripsi_produk_jasa') ? 'is-invalid':'' ?>" type="text" name="txt_deskripsi_produk_jasa" placeholder="Deskripsi Produk/Jasa" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_bukti') ? 'is-invalid':'' ?>" type="text" name="txt_bukti" placeholder="Bukti" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_tahun') ? 'is-invalid':'' ?>" type="text" name="txt_tahun" placeholder="Tahun" />
                        <div class="invalid-feedback">
