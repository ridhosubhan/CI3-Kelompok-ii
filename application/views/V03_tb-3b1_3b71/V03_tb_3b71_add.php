...
<html lang="en">
  <head>
    ...
    <title>Luaran Penelitian/PkM Lainnya - HKI (Paten, Paten Sederhana)</title>
  </head>
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b71/index') ?>" class="btn btn-primary float-start">Back</a>
        </div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo site_url('/C03_tb_3b71/add') ?>" method="post" enctype="multipart/form-data" >
                <div class="mb-3 row">
                    <label for="txt_luaran_penelitian_dan_pkm" class="col-sm-2 col-form-label">Luaran Penelitan dan PKM<span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <select name="txt_luaran_penelitian_dan_pkm" class="form-control <?php echo form_error('txt_luaran_penelitian_dan_pkm') ? 'is-invalid':'' ?>" aria-label="Default select example">
                            <option selected disabled>Pilih Luaran Penelitian dan PKM</option>
