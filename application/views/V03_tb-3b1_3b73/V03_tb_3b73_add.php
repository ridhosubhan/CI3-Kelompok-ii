  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b73/index') ?>" class="btn btn-primary float-start">Back</a>
        </div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo site_url('/C03_tb_3b73/add') ?>" method="post" enctype="multipart/form-data" >
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select name="txt_luaran_penelitian_dan_pkm" class="form-control <?php echo form_error('txt_luaran_penelitian_dan_pkm') ? 'is-invalid':'' ?>" aria-label="Default select example">
                            ...
                            <option value="1">Teknologi Tepat Guna</option>
                            <option value="2">Produk (Produk Terstandarisasi, Produk Tersertifikasi)</option>
                            <option value="3">Karya Seni</option>
                            <option value="4">Rekayasa Sosial</option>
                        </select>
