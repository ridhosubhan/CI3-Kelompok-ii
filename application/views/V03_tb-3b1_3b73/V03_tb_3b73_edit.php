  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b73/index') ?>" class="btn btn-primary float-start">Back</a> <h3>EDIT DATA</h3>
        </div>
        <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data" >
                <input type="hidden" name="txt_id" value="<?php echo $tb_3b73->id?>" />
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select name="txt_luaran_penelitian_dan_pkm" class="form-control <?php echo form_error('txt_luaran_penelitian_dan_pkm') ? 'is-invalid':'' ?>" aria-label="Default select example">
                            ...
                            <option value="1" <?= $tb_3b73->luaran_penelitian_pkm == '1' ? 'selected' : '' ?> >Teknologi Tepat Guna</option>
                            <option value="2" <?= $tb_3b73->luaran_penelitian_pkm == '2' ? 'selected' : '' ?> >Produk (Produk Terstandarisasi, Produk Tersertifikasi)</option>
                            <option value="3" <?= $tb_3b73->luaran_penelitian_pkm == '3' ? 'selected' : '' ?> >Karya Seni</option>
                            <option value="4" <?= $tb_3b73->luaran_penelitian_pkm == '4' ? 'selected' : '' ?> >Rekayasa Sosial</option>
                        </select>
