                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="150">
                                <?php 
                                 if($data->luaran_penelitian_pkm==1){
                                     ...
                                     echo "Produk (Produk Terstandarisasi, Produk Tersertifikasi)";
                                 }
                                 else if($data->luaran_penelitian_pkm==3){
                                     echo "Karya Seni";
                                 }
                                 else if($data->luaran_penelitian_pkm==4){
                                     echo "Rekayasa Sosial";
                                 }                         
                                 else{
                                     echo "-";
                                 }
                            ...
                            <td width="150">
                                <a href="<?php echo site_url('/C03_tb_3b73/edit/'.$data->id) ?>"
                                    class="btn btn-small btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                <button  onclick="deleteConfirm('<?php echo site_url('/C03_tb_3b73/delete/'.$data->id) ?>')"
