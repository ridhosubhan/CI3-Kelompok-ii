  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b42/index') ?>" class="btn btn-primary float-start">Back</a>
        </div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo site_url('/C03_tb_3b42/add') ?>" method="post" enctype="multipart/form-data" >
                <div class="mb-3 row">
