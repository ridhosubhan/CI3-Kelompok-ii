  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b42/index') ?>" class="btn btn-primary float-start">Back</a> <h3>EDIT DATA</h3>
        </div>
        <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data" >
                <input type="hidden" name="txt_id" value="<?php echo $tb_3b42->id?>" />
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select name="txt_jenis_publikasi" class="form-control <?php echo form_error('txt_jenis_publikasi') ? 'is-invalid':'' ?>" aria-label="Default select example">
                            ...
                            <option value="1" <?= $tb_3b42->jenis_publikasi == '1' ? 'selected' : '' ?> >Jurnal penelitian tidak terakreditasi</option>
                            <option value="2" <?= $tb_3b42->jenis_publikasi == '2' ? 'selected' : '' ?> >Jurnal penelitian nasional terakreditasi</option>
                            <option value="3" <?= $tb_3b42->jenis_publikasi == '3' ? 'selected' : '' ?> >Jurnal penelitian internasional</option>
                            <option value="4" <?= $tb_3b42->jenis_publikasi == '4' ? 'selected' : '' ?> >Jurnal penelitian internasional bereputasi</option>
                            <option value="5" <?= $tb_3b42->jenis_publikasi == '5' ? 'selected' : '' ?> >Seminar wilayah/lokal/perguruan tinggi</option>
                            <option value="6" <?= $tb_3b42->jenis_publikasi == '6' ? 'selected' : '' ?> >Seminar nasional</option>
                            <option value="7" <?= $tb_3b42->jenis_publikasi == '7' ? 'selected' : '' ?> >Seminar internasional</option>
                            <option value="8" <?= $tb_3b42->jenis_publikasi == '8' ? 'selected' : '' ?> >Tulisan di media massa wilayah</option>
                            <option value="9" <?= $tb_3b42->jenis_publikasi == '9' ? 'selected' : '' ?> >Tulisan di media massa nasional</option>
                            <option value="10" <?= $tb_3b42->jenis_publikasi == '10' ? 'selected' : '' ?> >Tulisan di media massa internasional</option>
                        </select>
