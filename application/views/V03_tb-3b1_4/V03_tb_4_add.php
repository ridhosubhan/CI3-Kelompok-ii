  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_4/index') ?>" class="btn btn-primary float-start">Back</a>
        </div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo site_url('/C03_tb_4/add') ?>" method="post" enctype="multipart/form-data" >
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select name="txt_jenis_penggunaan" class="form-control <?php echo form_error('txt_jenis_penggunaan') ? 'is-invalid':'' ?>" aria-label="Default select example">
                            ...
                            <option value="1">Biaya Operasional Pendidikan <br> a. Biaya Dosen (Gaji, Honor)</option>
                            <option value="2">Biaya Operasional Pendidikan <br> b. Biaya Tenaga Kependidikan (Gaji, Honor)</option>
                            <option value="3">Biaya Operasional Pendidikan <br> c. Biaya Operasional Pembelajaran (Bahan dan Peralatan Habis Pakai)</option>
                            <option value="4">Biaya Operasional Pendidikan <br> d. Biaya Operasional Tidak Langsung (Listrik, Gas, Air, Pemeliharaan Gedung, Pemeliharaan Sarana, Uang Lembur, Telekomunikasi, Konsumsi, Transport Lokal, Pajak, Asuransi, dll.)</option>
                            <option value="5">Biaya operasional kemahasiswaan (penalaran, minat, bakat, dan kesejahteraan).</option>
                            <option value="6">Jumlah <br> Biaya Penelitian</option>
                            <option value="7">Jumlah <br> Biaya PkM</option>
                            <option value="8">Jumlah <br> Biaya Investasi SDM</option>
                            <option value="9">Jumlah <br> Biaya Investasi Sarana</option>
                            <option value="10">Jumlah <br> Biaya Investasi Prasarana</option>
                        </select>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_upps_ts_2') ? 'is-invalid':'' ?>" type="text" name="txt_upps_ts_2" placeholder="Unit Pengelola Program Studi (Rupiah)" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    <label for="txt_upps_ts_2" class="col-sm-2 col-form-label">Unit Pengelola Program Studi<span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_upps_ts_2') ? 'is-invalid':'' ?>" type="text" name="txt_upps_ts_2" placeholder="Unit Pengelola Program Studi (Rupiah) TS-2" />
                        <div class="invalid-feedback">
                            <?php echo form_error('txt_upps_ts_2') ?>
                        </div>
                    </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_upps_ts_1') ? 'is-invalid':'' ?>" type="text" name="txt_upps_ts_1" placeholder="Unit Pengelola Program Studi (Rupiah) TS-1" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_upps_ts') ? 'is-invalid':'' ?>" type="text" name="txt_upps_ts" placeholder="Unit Pengelola Program Studi (Rupiah) TS" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_upps_ts_rata') ? 'is-invalid':'' ?>" type="text" name="txt_upps_ts_rata" placeholder="Unit Pengelola Program Studi (Rupiah) Rata-rata" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_ps_ts_2') ? 'is-invalid':'' ?>" type="text" name="txt_ps_ts_2" placeholder="Program Studi TS-2 (Rupiah)" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_ps_ts_1') ? 'is-invalid':'' ?>" type="text" name="txt_ps_ts_1" placeholder="Program Studi TS-1 (Rupiah)" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_ps_ts') ? 'is-invalid':'' ?>" type="text" name="txt_ps_ts" placeholder="Program Studi TS (Rupiah)" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_ps_ts_rata') ? 'is-invalid':'' ?>" type="text" name="txt_ps_ts_rata" placeholder="Program Studi Rata-rata (Rupiah)" />
                        <div class="invalid-feedback">
