...
<html lang="en">
  <head>
    ...
    <title>Luaran Penelitian/PkM Lainnya - HKI (Hak Cipta, Desain Produk Industri, dll.)</title>
  </head>
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b72/index') ?>" class="btn btn-primary float-start">Back</a> <h3>EDIT DATA</h3>
        </div>
        <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data" >
                <input type="hidden" name="txt_id" value="<?php echo $tb_3b72->id?>" />
                <div class="mb-3 row">
                    <label for="txt_luaran_penelitian_dan_pkm" class="col-sm-2 col-form-label">Jenis Publikasi<span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <select name="txt_luaran_penelitian_dan_pkm" class="form-control <?php echo form_error('txt_luaran_penelitian_dan_pkm') ? 'is-invalid':'' ?>" aria-label="Default select example">
                            ...
                            <option value="1" <?= $tb_3b72->luaran_penelitian_dan_pkm == '1' ? 'selected' : '' ?> >Hak Cipta</option>
                            <option value="2" <?= $tb_3b72->luaran_penelitian_dan_pkm == '2' ? 'selected' : '' ?> >Desain Produk Industri</option>
                            <option value="3" <?= $tb_3b72->luaran_penelitian_dan_pkm == '3' ? 'selected' : '' ?> >Perlindungan Varietas Tanaman</option>
                            <option value="4" <?= $tb_3b72->luaran_penelitian_dan_pkm == '4' ? 'selected' : '' ?> >Desain Tata Letak Sirkuit Terpadu</option>
                            <option value="5" <?= $tb_3b72->luaran_penelitian_dan_pkm == '5' ? 'selected' : '' ?> >Dan Lain-lain</option>
                        </select>
