  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b72/index') ?>" class="btn btn-primary float-start">Back</a>
        </div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo site_url('/C03_tb_3b72/add') ?>" method="post" enctype="multipart/form-data" >
                <div class="mb-3 row">
                    <label for="txt_jenis_publikasi" class="col-sm-2 col-form-label">Luaran Penelitian dan PKM<span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <select name="txt_luaran_penelitian_dan_pkm" class="form-control <?php echo form_error('txt_luaran_penelitian_dan_pkm') ? 'is-invalid':'' ?>" aria-label="Default select example">
                            ...
                            <option value="3">Perlindungan Varietas Tanaman</option>
                            <option value="4">Desain Tata Letak Sirkuit Terpadu</option>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control <?php echo form_error('txt_keterangan') ? 'is-invalid':'' ?>" type="text" name="txt_keterangan" placeholder="Keterangan" />
                        <div class="invalid-feedback">
