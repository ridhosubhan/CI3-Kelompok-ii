  ...
  <body>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('/C03_tb_3b74/add') ?>" class="btn btn-primary float-start">Tambah Data</a>
            <a href="<?php echo site_url('/C03_tb_3b74/print') ?>" target="_blank" href="#" class=" ms-3 btn btn-info text-white float-start">Print</a>
            <h3>Luaran Penelitian/PkM Lainnya - Buku ber-ISBN, Book Chapter</h3>
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="150">
                                <a href="<?php echo site_url('/C03_tb_3b74/edit/'.$data->id) ?>"
                                    class="btn btn-small btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                <button  onclick="deleteConfirm('<?php echo site_url('/C03_tb_3b74/delete/'.$data->id) ?>')"
