...
<form id="form" method="post" action="Proses_TampilkanProdi"> 
<div id="container">
<CENTER>
<table width="1027" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td colspan="9"><span class="form-group"></span></td>
    <td width="10"></td><td colspan="9">&nbsp;</td>
  </tr>
  <tr>
    <th width="61" scope="col"><span class="style31">FORM-5</span></th>
    <th colspan="2" class="style33" scope="col"><div align="center">MELIHAT AKUNTABILITAS DATA DOSEN PER PROGRAM STUDI</div></th>
...
<table  bgcolor="#87CEEB" width="1028" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="post" action="Tampilkan_Prodi">
      <label></label>
      <select name="menu1" onchange="#">
	    <option>0. Pilih </option>
        <option>1. Tampilkan Data</option>
        <option>2. Batal</option>
      </select>
  ...
  <tr>
    <td colspan="9"><form name="form2" id="form2">
      </form>    </td>
    <td></td>
  </tr>
  <tr><td colspan="9"><span class="form-group"></span></td><td width="10"></td><td colspan="3"></td></tr>
  <td colspan="9"><span class="form-group"></span></td>
  <td width="10"></td><td colspan="9">&nbsp;</td>
</table>
<tr>
